...
async function runAssistantCommand() {
  ...
  async function saveSettings(e) {
    ...
    const GoldBuyPrem = parseInt(settings.GoldBuyPrem || 0, 10);
    const GoldSellPrem = parseInt(settings.GoldSellPrem || 0, 10);
    const GoldRoundoffMultiple = Math.max(
      1,
      parseInt(settings.GoldRoundoffMultiple || 100, 10)
    );
    const autoContract =
...
const currentLog = {
  ...
  silver100rate: newSettings.silver100rate,
  silver100buy: newSettings.silver100buy,
  silver100sell: newSettings.silver100sell,
  GoldBuyPrem: newSettings.GoldBuyPrem,
  GoldSellPrem: newSettings.GoldSellPrem,
  ShowGoldRate: newSettings.ShowGoldRate,
  ShowGoldPrem: newSettings.ShowGoldPrem,
  GoldRoundoffMultiple: newSettings.GoldRoundoffMultiple,
  GoldManualContract: newSettings.GoldManualContract,
};
