...
const translations = {
  ...
  hi: {
    ...
    utilities: "Utilities",
    theme: "Theme",
    keepScreenOn: "Screen On रखें",
    quickActions: "Quick Actions",
    enableNotifications: "Notifications Enable करें",
    feedback: "Feedback",
    account: "Account",
    logout: "Logout",
    disclaimerTitle: "Disclaimer",
    disclaimerText: "Rates indicative हैं और enquiry के time confirmation के अनुसार बदल सकते हैं.",
    marketOpen: "Market Open",
    marketClosed: "Market Closed",
    holidayMode: "Holiday Mode",
    lastUpdated: "Last updated",
    volatilityTitle: "⚠️ MARKET VOLATILITY ALERT! ⚠️",
    volatilityBody: "Trade करने से पहले कृपया call करके rate confirm करें.",
    alertsTitle: "My Rate Alerts",
    alertsSubtitle: "MCX buy/sell rates पर alerts set करें. Maximum 5 active alerts.",
    rateType: "Rate Type",
    condition: "Condition",
    targetRate: "Target Rate",
    belowEqual: "Below or Equal",
    aboveEqual: "Above or Equal",
    saveAlert: "Alert Save करें",
    remove: "Remove",
    noAlerts: "No active alerts.",
    alertSaved: "Alert successfully save हो गया है.",
    alertRemoved: "Alert remove हो गया है.",
    notificationEnabled: "Notifications enable हो गए हैं.",
    notificationDenied: "Notification permission नहीं मिली.",
    notificationUnsupported: "इस device पर notifications supported नहीं हैं.",
    ...
    weSellAt: "We Sell at :",
    previousClosing: "Previous Closing",
    ratesUnavailable: "Live rates अभी available नहीं हैं",
    visitAgain: "कृपया market hours में फिर से visit करें.",
    loadingRates: "Rates load हो रहे हैं... कृपया wait करें...",
    liveBullion: "LIVE MCX BULLION FUTURES",
    finalDisclaimer: "Rates market conditions और applicable premiums पर based हैं. Final rates confirmation के time बदल सकते हैं.",
  },
};
...
function languageWelcome(t, firstName) {
  return t.language === "भाषा" ? `Welcome, ${firstName} 👋` : `Welcome, ${firstName} 👋`;
}
...
function WelcomeToast({ profile, visible, t }) {
  ...
  return (
    <div style={styles.welcomeToast}>
      ...
      <div style={styles.welcomeTitle}>{languageWelcome(t, firstName)}</div>
      <div style={styles.welcomeSubtitle}>
        {t.language === "भाषा" ? "आपका live rates access आज के लिए active है." : "Your live rates access is active for today."}
      </div>
...
function LanguageSelector({ language, onChange }) {
  return (
    <select style={styles.languageSelect} value={language} onChange={(e) => onChange(e.target.value)}>
