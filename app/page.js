...
function WelcomeToast({ profile, visible }) {
  if (!visible || !profile) {
    return null;
  }
  ...
  return (
    <div style={styles.welcomeToast}>
      ...
      <div style={styles.welcomeTitle}>Welcome, {firstName} 👋</div>
...
/>
  ...
  <div style={{ marginTop: 16 }}>  <span style={styles.liveDot} />
        ...
        <WelcomeToast profile={dealerProfile} visible={showWelcomeCard} />
    </section>
...
const styles = {
  ...
  welcomeToast: {
    ...
    margin: "20px auto 0",
    background:
      "linear-gradient(135deg, rgba(255,255,255,0.12), rgba(255,255,255,0.025)), radial-gradient(circle at top left, rgba(243,217,139,0.22), transparent 42%), rgba(18, 17, 13, 0.62)",
    backdropFilter: "blur(18px) saturate(135%)",
    WebkitBackdropFilter: "blur(18px) saturate(135%)",
    border: "1px solid rgba(243, 217, 139, 0.42)",
    boxShadow:
      "0 18px 48px rgba(0,0,0,0.34), inset 0 1px 0 rgba(255,255,255,0.12)",
    color: "var(--rj-brand)",
    borderRadius: 24,
