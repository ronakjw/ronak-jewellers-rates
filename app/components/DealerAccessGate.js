...
const LANGUAGE_KEY = "rj-language";

const gateText = {
  en: {
    brand: "Ronak Jewellers",
    dealerAccess: "DEALER ACCESS LOGIN",
    ...
    accessNote: "Access for authorized users only.",
  ...
  hi: {
    brand: "Ronak Jewellers",
    dealerAccess: "डीलर एक्सेस लॉगिन",
    checking: "Access check हो रहा है...",
    intro: "",
    mobile: "",
    placeholder: "अपना 10-digit Mobile Number डालें",
    continue: "Continue",
    checkingButton: "Checking...",
    sendingOtp: "OTP भेज रहे हैं...",
    enterOtp: "OTP Enter करें",
    otpPlaceholder: "OTP",
    verify: "Verify & Continue",
    verifying: "Verifying...",
    changeNumber: "Number बदलें",
    validNumber: "Valid 10-digit mobile number enter करें.",
    notAuthorized: "यह number live rates देखने के लिए authorized नहीं है.",
    unable: "Access verify नहीं हो पाया. कृपया दोबारा try करें.",
    otpSent: "New device detected. OTP आपके registered number पर भेजा गया है.",
    otpInactive: "OTP service active नहीं है. कृपया Ronak Jewellers से contact करें.",
    otpAgain: "कृपया OTP दोबारा request करें.",
    enterOtpMsg: "OTP enter करें.",
    differentOtp: "OTP अलग number के लिए verify हुआ है. कृपया दोबारा try करें.",
    approveFailed: "इस device को approve नहीं कर पाए. कृपया दोबारा try करें.",
    invalidOtp: "Invalid OTP या OTP expire हो गया है. कृपया दोबारा try करें.",
    accessNote: "केवल authorized users के लिए access.",
    inactive: "आपका access active नहीं है. कृपया Ronak Jewellers से contact करें.",
    newDevice: "यह number new device पर use हो रहा है. कृपया फिर से verify करें.",
    logoutSuccess: "Logout successful.",
    loginAgain: "Login Again",
    feedbackTitle: "Feedback भेजें",
    feedbackPlaceholder: "अपना feedback यहां लिखें...",
    submitFeedback: "Feedback Submit करें",
    feedbackSuccess: "धन्यवाद. Feedback submit हो गया है.",
    feedbackEmpty: "Feedback submit करने से पहले कुछ लिखें.",
    feedbackFailed: "Feedback submit नहीं हो पाया. कृपया दोबारा try करें.",
    language: "भाषा",
  },
};
...
export default function DealerAccessGate({
  ...
  useEffect(() => {
    if (languageProp === "hi" || languageProp === "en") {
      setLanguage(languageProp);
    }
  }, [languageProp]);

  function updateLanguage(nextLanguage) {
    const safeLanguage = nextLanguage === "hi" ? "hi" : "en";
    setLanguage(safeLanguage);
    try {
      window.localStorage.setItem(LANGUAGE_KEY, safeLanguage);
    } catch {}
    onLanguageChange?.(safeLanguage);
  }

  useEffect(() => {
    try {
      const savedLanguage = window.localStorage.getItem(LANGUAGE_KEY);
      if ((savedLanguage === "hi" || savedLanguage === "en") && !languageProp) {
    ...
    <main style={{ ...styles.page, ...(theme === "light" ? styles.lightVars : styles.darkVars) }}>
      <section style={styles.card}>
        <div style={styles.languageRow}>
          ...
          <select style={styles.languageSelect} value={language} onChange={(e) => updateLanguage(e.target.value)}>
...
const styles = {
  ...
  brand: { color: "var(--gate-brand)", margin: "4px 0 18px", fontSize: "clamp(30px, 7vw, 42px)", fontWeight: 800 },
  accessTitle: { color: "var(--gate-muted)", margin: "0 0 22px", fontSize: "clamp(18px, 4vw, 22px)", fontWeight: 800, letterSpacing: "0.03em", textTransform: "uppercase" },
