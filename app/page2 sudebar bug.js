...
function GlobalAnimationStyles() {
  return (
    <style>{`
      ...
      @keyframes rjTogglePulse {
        0% { box-shadow: 0 0 0 rgba(214, 180, 92, 0); }
        50% { box-shadow: 0 0 18px rgba(214, 180, 92, 0.36); }
        100% { box-shadow: 0 0 0 rgba(214, 180, 92, 0); }
      }

      @keyframes rjSoftFloat {
...
const styles = {
  menuButton: {
    ...
    animation: "rjMenuPop 0.3s ease both, rjSoftFloat 3s ease-in-out infinite",
  },
  ...
  themeToggleWrap: {
    ...
    animation: "rjTogglePulse 2.4s ease-in-out infinite",
  },
